...
const Search = () => {
    ...
    <div>
        ...
        <aside id="default-sidebar" className="fixed top-20 -mr-80 left-0 z-40 w-64 h-fit transition-transform -translate-x-full sm:translate-x-20" aria-label="Sidebar">
            <div className="h-full px-3 py-4 overflow-y-auto bg-slate-900 dark:bg-slate-900 rounded-md">
            ...
            <div className="p-5 sm:ml-80">
                <div className="px-10">
                    <div className="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-3">
                        <div className="flex items-center justify-center h-[340px] w-[226px] rounded bg-gray-50 dark:bg-gray-800 drop-shadow-lg">
                            <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-2xl text-dark font-semibold">Movie</div>
                        </div>
                        <div className="flex items-center justify-center h-[340px] w-[226px]  rounded bg-gray-50 dark:bg-gray-800 drop-shadow-lg">
                            <div className="opacity-0 hover:opacity-100 duration-300 absolute inset-0 z-10 flex justify-center items-center text-2xl text-dark font-semibold">Movie</div>
                        </div>
